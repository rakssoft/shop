# Generated by Django 2.1.3 on 2018-12-22 20:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_tottal', models.DecimalField(decimal_places=2, default=0, max_digits=9)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='cartitem',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecomapp.Product'),
        ),
        migrations.AddField(
            model_name='cart',
            name='item',
